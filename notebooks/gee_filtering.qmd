...
```{python}
Map.addLayer(buffered_reservoirs, {}, "buffered_reservoirs")
Map
```
...
# Display the map
Map.addLayer(intersections, {'color': 'yellow'}, "intersecting_polygons")
Map
```
...
Map.addLayer(waterbodies_buffer, {}, 'waterbodies_buffer')
Map
```
