...
# intersecting_filter = ee.Filter.eq("intersects_buffer", 0)
# intersecting_water = wells_with_intersections.filter(intersecting_filter)

# sample = intersecting_water.limit(6).getInfo()
# print(json.dumps(sample, indent = 2))
