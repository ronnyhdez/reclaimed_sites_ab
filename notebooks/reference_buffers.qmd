...
# Check the properties to ensure 'wllst__' is included
print(buffer_only_polygons.first().getInfo())

# Export the resulting FeatureCollection to an asset
task = ee.batch.Export.table.toAsset(
    collection=buffer_only_polygons,
    description='buffer_only_polygons_export',
    assetId='projects/ee-ronnyale/assets/buffer_only_polygons_v1'
)

# Start the export task
task.start()

# Print status of the export task
print("Export task started. Monitor the task in the Earth Engine Code Editor under 'Tasks'.")
