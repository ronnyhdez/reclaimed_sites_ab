...
if __name__ == "__main__":
    ...
    # fires = gpd.read_file('downloaded_data/NFDB_poly_20210707.shp')
    ...
    abandoned_wells = gpd.read_file('downloaded_data/HFI2021.gdb',
