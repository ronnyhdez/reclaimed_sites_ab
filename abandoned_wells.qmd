...
The number of polygons with at least 20 years are `r at_least_20`

::: {.column-margin}
This is looking just at the reclamation year, without filtering by any other
variable. Therefore, number of observations could be lower due to other 
filtering criteria based on variables other than reclamation maximum year.
:::
...
## Dates in reclaimed sites

We have that some dates has some incosistencies when considering all the
...
<!-- ```{r} -->
<!-- glimpse(abandoned_wells_df) -->


<!-- range(abandoned_wells$shape_length) -->

<!-- test <- abandoned_wells |>  -->
<!--         mutate(div = shape_area / shape_length) |>  -->
<!--         arrange(desc(div)) |>  -->
<!--         select(wellsite_footprint_id, div, shape_area, -->
<!--                shape_length, Shape) -->

<!-- test |>  -->
<!--         filter(wellsite_footprint_id == 276359) |>  -->
<!--         ggplot() + -->
<!--         geom_sf()  -->

<!-- range(test$div) -->
<!-- range(test$shape_length) -->
<!-- ``` -->
